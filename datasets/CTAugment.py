# CTAugment implementation from https://github.com/google-research/fixmatch/blob/master/libml/ctaugment.py
#
...
class CTAugment:
    def __init__(self, depth=2, th=0.8, decay=0.99):
        self.decay = decay
        self.depth = depth
        self.th = th
        self.rates = {}
    ...
    def policy(self, probe):
        '''
        probe: True if learning parameters (using labeled data), False for unlabeled data
        '''
        kl = list(OPS.keys())
        v = []
        if probe:
